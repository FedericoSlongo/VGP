...
function DecryptModal(props: ModalProps & { message: string; }) {
    return (
...
export function buildDecryptModal(decryptedMessage) {
    openModal(props => <DecryptModal {...props} message={decryptedMessage} />);
}
